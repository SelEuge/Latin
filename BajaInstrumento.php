...
<body>
	  <div id="contenedor"> <!-- Inicio bloque CONTENEDOR -->
           ...
           <div id="formulario"> --> 
				...
				echo "<tr>";//COMIENZA UNA FILA
				while($registros=mysql_fetch_array($resultado)){
					if($cantImag == 3){
						echo "</tr>";//CUANDO LA IMAGEN ES IGUAL A 3: CIERRA LA FILA
						echo "<tr>";//ABRE OTRA FILA
						$cantImag = 0;//INICIA LA VARIABLE PARA QUE CARGUE 3 IMAGENES DE NUEVO POR FILA
					}
					echo "<td>";
					echo "<a href=BajaConfirmada.php?valor=".$registros['codigo']."><img src=$registros[ruta]></a><br>";
					echo "<b>Nombre:</b> ".$registros['nombre']."<br>";
					echo "<b>Modelo:</b> ".$registros['modelo']."<br>";
					echo "<b>Código:</b> ".$registros['codigo']."<img id=foto alt=a src=animacion/Iconos/Logo-eliminar.png>";								
					echo "</td>";
					$cantImag ++;
				}
				echo "</tr>";
